...
The config file has two sections namely content and config separated by a delimiter (__CONFIG__). The content section could have simple template varibles of the the sytle %VARNAME%, for which the values are provided on the config section.
